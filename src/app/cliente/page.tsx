...
import { Play, Trophy, Flame, ArrowRight, Droplet, Moon, BarChart3, Scale, Gift } from "lucide-react";
    ...
    >
        ...
        <div className="mt-1 flex items-center justify-between">
          <div>
            <div className="text-xl font-semibold">
              {nextWorkout?.name ?? "Nenhum treino atribuído"}
            </div>
            <div className="text-xs text-atlas-muted">
          ...
          {nextWorkout && (
            <Link
              href={`/cliente/treinos/${nextWorkout.id}/iniciar`}
      ...
      <div className="mt-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <Link href="/cliente/conquistas" className="text-xs text-atlas-energy">
